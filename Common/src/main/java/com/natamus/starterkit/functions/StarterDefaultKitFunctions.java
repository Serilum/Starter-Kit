...
public class StarterDefaultKitFunctions {
	...
	public static String getArcherKitGearString() {
		...
		for (int i = 0; i < emptyInventoryList.size(); i++) {
			...
			if (i == 0) {
				itemString = "{count:1,id:\"minecraft:bow\",components:{\"minecraft:enchantments\":{\"minecraft:power\":1}}}";
			}
			else if (i == 7) {
	...
	public static String getLumberjackKitGearString() {
		...
		for (int i = 0; i < emptyInventoryList.size(); i++) {
			...
			if (i == 0) {
				itemString = "{count:1,id:\"minecraft:iron_axe\",components:{\"minecraft:enchantments\":{\"minecraft:efficiency\":1}}}";
			}
			else if (i == 8) {
