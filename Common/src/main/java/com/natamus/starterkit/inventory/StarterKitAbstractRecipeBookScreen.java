...
public abstract class StarterKitAbstractRecipeBookScreen<T extends RecipeBookMenu> extends StarterKitAbstractContainerScreen<T> implements RecipeUpdateListener {
    ...
    public void render(@NotNull GuiGraphicsExtractor $$0, int $$1, int $$2, float $$3) {

    }

    protected void renderSlots(GuiGraphicsExtractor $$0) {
    ...
    protected void slotClicked(Slot $$0, int $$1, int $$2, ContainerInput $$3) {
