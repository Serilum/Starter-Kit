...
public class StarterKitInventoryMenu extends AbstractCraftingMenu {
    ...
    public static final Identifier BLOCK_ATLAS = Identifier.parse("textures/atlas/blocks.png");
    ...
    static final Identifier[] TEXTURE_EMPTY_SLOTS;
    ...
    static {
        TEXTURE_EMPTY_SLOTS = new Identifier[]{EMPTY_ARMOR_SLOT_BOOTS, EMPTY_ARMOR_SLOT_LEGGINGS, EMPTY_ARMOR_SLOT_CHESTPLATE, EMPTY_ARMOR_SLOT_HELMET};
